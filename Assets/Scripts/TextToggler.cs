...
public class TextToggler : MonoBehaviour
{
	...
	// This is a toggling platform script recycled to toggle the text in HUD for visual effect :)
	// Refernece to platfroms = THe text game object really
	
	[SerializeField]
	GameObject[] platforms; // Array of platforms this manager will control

	private int numberOfPlatforms; // How many platforms this manager controls

	private float toggleTime; // Time till the platform wll toggle

	[SerializeField] float cycleTime = 2f; // Rate at which platforms under this manager toggle at
